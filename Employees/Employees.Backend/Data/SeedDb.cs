...
public class SeedDb
{
    ...
    private async Task checkEmpleadosAsync()
    {
        if (!_context.Empleados.Any())
        {
            ...
            _context.Empleados.Add(new Empleado { FirstName = "Carlos", LastName = "Rodriguez", IsActive = true, HireDate = new DateTime(2022, 2, 14), Salary = 3100000 });
            ...
            _context.Empleados.Add(new Empleado { FirstName = "Andres", LastName = "Lopez", IsActive = true, HireDate = new DateTime(2023, 3, 5), Salary = 2800000 });
            ...
            _context.Empleados.Add(new Empleado { FirstName = "Julian", LastName = "Moreno", IsActive = true, HireDate = new DateTime(2021, 6, 22), Salary = 2900000 });
            ...
            _context.Empleados.Add(new Empleado { FirstName = "Manuel", LastName = "Cardenas", IsActive = true, HireDate = new DateTime(2023, 5, 11), Salary = 3050000 });
            ...
            _context.Empleados.Add(new Empleado { FirstName = "Sebastian", LastName = "Vargas", IsActive = true, HireDate = new DateTime(2018, 7, 14), Salary = 5200000 });
            ...
            _context.Empleados.Add(new Empleado { FirstName = "Mateo", LastName = "Sanchez", IsActive = true, HireDate = new DateTime(2022, 11, 23), Salary = 3400000 });
            ...
            _context.Empleados.Add(new Empleado { FirstName = "Angelica", LastName = "Guzman", IsActive = true, HireDate = new DateTime(2018, 6, 10), Salary = 5100000 });
            ...
            _context.Empleados.Add(new Empleado { FirstName = "Cristian", LastName = "Munoz", IsActive = true, HireDate = new DateTime(2019, 9, 21), Salary = 4600000 });
            _context.Empleados.Add(new Empleado { FirstName = "Carolina", LastName = "Fernandez", IsActive = true, HireDate = new DateTime(2022, 7, 28), Salary = 3250000 });
            _context.Empleados.Add(new Empleado { FirstName = "Esteban", LastName = "Rincon", IsActive = true, HireDate = new DateTime(2020, 12, 5), Salary = 4100000 });
            ...
            _context.Empleados.Add(new Empleado { FirstName = "Jorge", LastName = "Mejia", IsActive = true, HireDate = new DateTime(2018, 5, 13), Salary = 4900000 });
            ...
            _context.Empleados.Add(new Empleado { FirstName = "Monica", LastName = "Ramirez", IsActive = true, HireDate = new DateTime(2023, 8, 26), Salary = 2850000 });
            ...
            _context.Empleados.Add(new Empleado { FirstName = "Sandra", LastName = "Pena", IsActive = true, HireDate = new DateTime(2022, 5, 4), Salary = 3400000 });
            ...
            _context.Empleados.Add(new Empleado { FirstName = "Veronica", LastName = "Perez", IsActive = true, HireDate = new DateTime(2023, 3, 12), Salary = 3250000 });
            _context.Empleados.Add(new Empleado { FirstName = "Andres", LastName = "Gaitan", IsActive = true, HireDate = new DateTime(2018, 11, 7), Salary = 5400000 });
            ...
            _context.Empleados.Add(new Empleado { FirstName = "Camilo", LastName = "Hernandez", IsActive = true, HireDate = new DateTime(2022, 8, 1), Salary = 3650000 });
            _context.Empleados.Add(new Empleado { FirstName = "Liliana", LastName = "Suarez", IsActive = true, HireDate = new DateTime(2021, 1, 28), Salary = 4200000 });
            ...
            _context.Empleados.Add(new Empleado { FirstName = "Rocio", LastName = "Valencia", IsActive = true, HireDate = new DateTime(2019, 3, 18), Salary = 3900000 });
            ...
            _context.Empleados.Add(new Empleado { FirstName = "Raul", LastName = "Zapata", IsActive = true, HireDate = new DateTime(2021, 5, 25), Salary = 3550000 });
            _context.Empleados.Add(new Empleado { FirstName = "Nataly", LastName = "Rincon", IsActive = true, HireDate = new DateTime(2018, 9, 2), Salary = 5100000 });
            _context.Empleados.Add(new Empleado { FirstName = "Alvaro", LastName = "Jimenez", IsActive = true, HireDate = new DateTime(2020, 11, 3), Salary = 3850000 });
            ...
            _context.Empleados.Add(new Empleado { FirstName = "Carlos", LastName = "Guzman", IsActive = true, HireDate = new DateTime(2022, 3, 27), Salary = 3700000 });
            ...
            _context.Empleados.Add(new Empleado { FirstName = "Ernesto", LastName = "Cuellar", IsActive = true, HireDate = new DateTime(2023, 10, 2), Salary = 3600000 });
            _context.Empleados.Add(new Empleado { FirstName = "Fabian", LastName = "Ortega", IsActive = true, HireDate = new DateTime(2018, 5, 5), Salary = 4150000 });
            _context.Empleados.Add(new Empleado { FirstName = "Gloria", LastName = "Maldonado", IsActive = true, HireDate = new DateTime(2020, 8, 24), Salary = 3500000 });
            _context.Empleados.Add(new Empleado { FirstName = "Hernan", LastName = "Palacios", IsActive = true, HireDate = new DateTime(2021, 11, 14), Salary = 2900000 });
            _context.Empleados.Add(new Empleado { FirstName = "Ivan", LastName = "Benitez", IsActive = true, HireDate = new DateTime(2022, 2, 7), Salary = 4400000 });
            _context.Empleados.Add(new Empleado { FirstName = "Jessica", LastName = "Cortes", IsActive = true, HireDate = new DateTime(2019, 4, 9), Salary = 3300000 });
            ...
            _context.Empleados.Add(new Empleado { FirstName = "Miguel", LastName = "Forero", IsActive = true, HireDate = new DateTime(2021, 9, 2), Salary = 4550000 });
            _context.Empleados.Add(new Empleado { FirstName = "Nicolas", LastName = "Ramos", IsActive = true, HireDate = new DateTime(2022, 12, 11), Salary = 3400000 });
            _context.Empleados.Add(new Empleado { FirstName = "Olga", LastName = "Sierra", IsActive = true, HireDate = new DateTime(2020, 7, 8), Salary = 4800000 });
            _context.Empleados.Add(new Empleado { FirstName = "Pablo", LastName = "Velez", IsActive = true, HireDate = new DateTime(2023, 1, 5), Salary = 3700000 });
            _context.Empleados.Add(new Empleado { FirstName = "Rafael", LastName = "Torralba", IsActive = true, HireDate = new DateTime(2018, 9, 15), Salary = 4000000 });
            _context.Empleados.Add(new Empleado { FirstName = "Silvia", LastName = "Carrasco", IsActive = true, HireDate = new DateTime(2021, 10, 6), Salary = 3100000 });
            _context.Empleados.Add(new Empleado { FirstName = "Tomas", LastName = "Delgado", IsActive = true, HireDate = new DateTime(2020, 3, 22), Salary = 4600000 });
            ...
            _context.Empleados.Add(new Empleado { FirstName = "Vanessa", LastName = "Gaitan", IsActive = true, HireDate = new DateTime(2019, 12, 28), Salary = 3750000 });
